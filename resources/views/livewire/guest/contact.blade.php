<main class="mt-[10%] lg:mt-[5%]">
    <section class="w-11/12 mx-auto">
        <div class="font-poppins text-[#151515] flex flex-col gap-16">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2">
                <div>
                    <img src="{{ asset('img/images/sobre_nosotros.png') }}" alt="sobre nosotros"
                        class="w-full h-full" />
                </div>
                    ...
                    <div class="flex flex-col justify-center items-start h-full gap-8">
                        ...
                        <div class="border-b-[2px] border-[#121212] inline-block">
                            <a href="/" class="flex">
                                ...
                                <img src="{{ asset('img/svg/comprar_ahora_arrow.svg') }}" alt="comprar" />
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <section class="w-11/12 mx-auto my-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div class="flex flex-col gap-1 justify-center items-center bg-[#F3F5F7] py-5">
                    <div class="flex justify-center items-center">
                        <img src="{{ asset('img/svg/icon_direccion.svg') }}" alt="direccion" />
                    </div>
                ...
                <div class="flex flex-col gap-1 justify-center items-center bg-[#F3F5F7] py-5">
                    <div class="flex justify-center items-center">
                        <img src="{{ asset('img/svg/icon_celular.svg') }}" alt="celular" />
                    </div>
                ...
                <div class="flex flex-col gap-1 justify-center items-center bg-[#F3F5F7] py-5">
                    <div class="flex justify-center items-center">
                        <img src="{{ asset('img/svg/icon_email.svg') }}" alt="email" />
                    </div>
        ...
        <div class="my-16 grid grid-cols-1 md:grid-cols-2 gap-16 justify-center items-center ">
            ...
            <form wire:submit.prevent="sendMessage" class="space-y-5 px-[8%]">
                <div>
                    <x-input-label for="nameInput" :value="__('Your full name')" />
                    <x-inputlogin wire:model.defer="state.name" id="nameInput" class="block mt-1 w-full sm:text-sm"
                        type="text" required />
                    <x-input-error for="state.name" class="mt-2" />
                </div>
                <div>
                    <x-input-label for="emailInput" :value="__('Email address')" />
                    <x-inputlogin wire:model.defer="state.email" id="emailInput" class="block mt-1 w-full sm:text-sm"
                        type="email" required />
                    <x-input-error for="state.email" class="mt-2" />
                </div>
                <div>
                    <x-input-label for="phoneInput" :value="__('Phone number')" />
                    <x-inputlogin wire:model.defer="state.phone" id="phoneInput" class="block mt-1 w-full sm:text-sm"
                        type="text" required />
                    <x-input-error for="state.phone" class="mt-2" />
                </div>
                <div>
                    <x-input-label for="messageInput" :value="__('Message')" />
                    <x-textarea wire:model.defer="state.message" id="messageInput"
                        class="block mt-1 w-full sm:text-sm" rows="4" required />
                    <x-input-error for="state.message" class="mt-2" />
                </div>
                <div>
                    <button class="text-white bg-[#74A68D] py-3 rounded-2xl cursor-pointer border-2 font-semibold text-[16px] text-center border-none w-full md:w-auto px-10 inline-block">
                        {{ __('Send message') }}
                    </button>
                </div>
            </form>
            ...
            <div class="flex justify-center items-center">
                <img src="{{ asset('img/images/imagen_ubicacion.png') }}" alt="ubicacion" />
            </div>
